<template>
  <div class="IndicationColor mb-2">
    <div
      class="p-2 text-dark">
      <div class="row">
          <div class="col-md-10 pointing" data-bs-toggle="collapse" :data-bs-target="'#textarea' + open.id" aria-expanded="true" :aria-controls="open.id" @click="arrowChange()">
                Textarea: {{open.label}}
          </div>
          <div class="col-md-2 ml-auto">
              <button class="btn text-dark" data-bs-toggle="collapse" :data-bs-target="'#textarea' + open.id" :aria-controls="open.id" @click="arrowChange()">
    ...
    <div class="collapse p-4" :id="'textarea' + open.id">
        <div class="row">
            <div class="col-5">
                <label>Label</label>
          ...
          swal({
              ...
              .then((willDelete) => {
                  if (willDelete) {
                      ...
                      this.delete = true;
                      this.getTextAreaDataModel(this.delete, this.open);
                  } else {
